    ...
    public partial class intialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealSuggestions", x => x.SuggestionID);
                    table.ForeignKey(
                        name: "FK_MealSuggestions_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealSuggestions_Restaurants_RestaurantID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantMeals", x => x.MealID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealSuggestions_UserID",
                table: "MealSuggestions",
                column: "UserID");
